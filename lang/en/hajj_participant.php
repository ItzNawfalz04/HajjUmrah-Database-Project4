...
return [
    'model_label' => 'Hajj Participant',
    'plural_model_label' => 'Hajj Pilgrims',
    'sections' => [
        'participant_picture' => 'Participant Picture',
        'participant_code' => 'Hajj Participant Code',
        'participant_info' => 'Hajj Participant Information',
        'address_info' => 'Hajj Participant Address',
    ...
    'descriptions' => [
        ...
        'unique_code' => 'Unique identifier code for Hajj participants.',
        
        //SECTION 2
        'participant_info' => 'Enter details about the Hajj participant.',

        //SECTION 3
        'address_info' => 'Enter the address details of the Hajj participant.',
    ...
    'buttons' => [
        ...
        'create_button_label' => 'Create Hajj Participant',
    ],
    'table_labels' => [
        'file_no'                => 'File No.',
        'registration_no'        => 'Registration No.',
