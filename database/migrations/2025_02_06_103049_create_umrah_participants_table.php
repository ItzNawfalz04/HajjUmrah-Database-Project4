...
return new class extends Migration
{
    ...
    {
        Schema::create('umrah_participants', function (Blueprint $table) {
            $table->uuid('id')->primary;
            $table->uuid('umrah_database_id');

            $table->foreign('umrah_database_id')
            ->references('id')
            ->on('umrah_databases')
            ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('umrah_participants');
    }
};
